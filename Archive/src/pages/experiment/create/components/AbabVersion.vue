<template>
    <el-form ref="form" :model="form" class="version">
        ...
        <div class="version">
            <el-row class="label-row param-row version-row">
                <el-form-item>
                    <el-input placeholder="请输入内容" v-model="aVersion" class="version" disabled="true"></el-input>
                </el-form-item>
                <el-form-item>
                    <el-select v-model="aVersion" placeholder="请选择参数名称" class="param-name" disabled="true">
                        <el-option
                ...
                <el-form-item>
                    <el-input placeholder="请输入内容aa" v-model="input" class="param-value" disabled="true"></el-input>
                </el-form-item>
                <el-form-item>
                    <el-popover placement="bottom" width="400" trigger="click" disabled="true">
                        剩余流量：32.43%
                        <el-slider v-model="aVersionFlowVal" show-input @change="handleSliderChange"></el-slider>
                        <el-input
                            slot="reference"
                            placeholder="请输入内容"
                            v-model="aVersionFlowVal"
                            class="flow"
                            disabled="true"
                        ></el-input>
                    </el-popover>
        ...
        <div class="version">
            <el-row class="label-row param-row version-row">
                <el-form-item>
                    <el-input placeholder="请输入内容" v-model="bVersion" class="version" disabled="true"></el-input>
                </el-form-item>
                <el-form-item>
                    <el-select v-model="bVersion" placeholder="请选择参数名称" class="param-name" disabled="true">
                        <el-option
                            v-for="item in options"
                            :key="item.value"
                            :label="item.label"
                ...
                <el-form-item>
                    <el-popover placement="bottom" width="400" trigger="click" disabled="true">
                        剩余流量：32.43%
                        <el-slider v-model="bVersionFlowVal" show-input @change="handleSliderChange"></el-slider>
                        <el-input
                            slot="reference"
                            placeholder="请输入内容"
                            v-model="bVersionFlowVal"
                            class="flow"
                            disabled="true"
                        >
                            <!-- <template slot="append">%</template> -->
