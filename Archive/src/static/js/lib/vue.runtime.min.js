...
!(function(t, e) {
    ...
    function Rn(t, e) {
        return { staticClass: Un(t.staticClass, e.staticClass), class: n(t.class) ? [t.class, e.class] : e.class };
    }
    function Un(t, e) {
        return t ? (e ? t + ' ' + e : t) : e || '';
    }
            ...
            e === zr
                ...
                : (f = (n = (l = Math.max(a, u)) > 0 ? (a > u ? zr : Wr) : null)
                      ? n === zr
                          ...
                          : c.length
                      : 0),
            { type: n, timeout: l, propCount: f, hasTransform: n === zr && eo.test(r[qr + 'Property']) }
        );
    }
    function ro(t, e) {
    ...
    var lo = (function(t) {
        ...
        for (i = 0; i < Qn.length; ++i)
            for (s[Qn[i]] = [], a = 0; a < c.length; ++a) n(c[a][Qn[i]]) && s[Qn[i]].push(c[a][Qn[i]]);
        function l(t) {
