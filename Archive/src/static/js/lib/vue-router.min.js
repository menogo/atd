...
!(function(t, e) {
    ...
    function s(t, e) {
        return e === qt
            ...
            : !!e &&
                  (t.path && e.path
                      ? t.path.replace(St, '') === e.path.replace(St, '') && t.hash === e.hash && p(t.query, e.query)
                      : !(!t.name || !e.name) &&
                        (t.name === e.name && t.hash === e.hash && p(t.query, e.query) && p(t.params, e.params)));
    }
    function p(t, e) {
    ...
    function M(t, e) {
        ...
        function n(t, n) {
            ...
            if (f) {
                var y = z(f, t);
                return r(
                    { _normalized: !0, path: S(y, d, 'redirect route with path "' + y + '"'), query: h, hash: l },
                    void 0,
                    n
                );
            }
